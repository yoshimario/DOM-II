...
window.onload = function (evt) {
  ...
  // 9- focus
const inputElement = document.querySelector('.footer')
inpuftElement.addEventListener('focus', () => {
  console.log('Input element focused!');
  // You can add your custom logic here when the input element is focused.
})
}